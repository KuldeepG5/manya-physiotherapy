const WhatsAppFloatingIcon = ({
  ...
  return (
    <div
      className="fixed bottom-6 right-6 z-50 cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-2xl"
    ...
    >
      <div className="relative">
        ...
        {/* Main icon container */}
        <div className="relative bg-green-500 hover:bg-green-600 rounded-full p-3 sm:p-4 shadow-lg transition-colors duration-300">
          {/* WhatsApp Icon SVG */}
          <svg
